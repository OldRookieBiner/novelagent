...
def upgrade() -> None:
    ...
    op.create_index('idx_relations_characters', 'relations', ['character_a_id', 'character_b_id'])
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['relation_id'], ['relations.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['triggered_plan_id'], ['evolution_plans.id'], ondelete='SET NULL'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.add_column('projects', sa.Column('novel_length', sa.Integer(), nullable=True, server_default='100000'))

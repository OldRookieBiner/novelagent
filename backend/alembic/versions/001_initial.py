...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "review_strictness", sa.String(20), nullable=True, default="standard"
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "chapter_count_confirmed", sa.Boolean(), nullable=True, default=False
        ),
    ...
    op.create_index(
        "ix_chapter_outlines_project_id", "chapter_outlines", ["project_id"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["chapter_outline_id"], ["chapter_outlines.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
